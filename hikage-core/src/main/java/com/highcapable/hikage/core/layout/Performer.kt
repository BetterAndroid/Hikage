...
fun <V : View, LP : ViewGroup.LayoutParams> Hikage.Performer<LP>.View(
    ...
    init: HikageView<V> = {}
) = resolveContext().View(viewClass, lparams, id, attrs, init)
...
) = resolveContext().View(lparams, id, attrs, init)
...
) = resolveContext().ViewGroup(viewClass, childLpClass, lparams, id, attrs, init, performer)
...
) = resolveContext().ViewGroup(viewClass, lparams, id, attrs, init, performer)
...
) = View(V::class, lparams, id, attrs, init)
...
) = ViewGroup(VG::class, NLP::class, lparams, id, attrs, init, performer)
...
) = ViewGroup(VG::class, lparams, id, attrs, init, performer)
