...
fun <V : View, LP : ViewGroup.LayoutParams> Hikage.Performer<LP>.View(
    ...
    id: String? = null,
    init: HikageView<V> = {}
) = resolveContext().View(viewClass, lparams, id, init)
...
) = resolveContext().ViewGroup(viewClass, childLpClass, lparams, id, init, performer)
...
) = resolveContext().ViewGroup(viewClass, lparams, id, init, performer)
