 ...
 *
 * ```kotlin
 * val first: Hikage = Hikagable(context) {
 *     TextView(id = "textView")
 * }
 * val second: Hikage = Hikagable(context) {
 *     TextView(id = "textView")
...
@Hikagable
context(performer: Hikage.Performer<LP>)
operator fun <LP : ViewGroup.LayoutParams> HikageBuilder.invoke(
    lparams: LayoutParams? = null,
    id: String? = null,
    embedded: Boolean = true
) = performer.Layout(this.build(), lparams, id, embedded)
