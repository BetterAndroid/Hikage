...
.mermaid-wrapper {
    ...
    // Mermaid measures labels outside .vp-doc before inserting the SVG. Keep VitePress's
    // paragraph spacing and line height from changing the measured foreignObject contents.
    :deep(foreignObject p) {
        margin: 0;
        line-height: inherit;
    }
}
