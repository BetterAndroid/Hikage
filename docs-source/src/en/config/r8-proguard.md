...
If you are using component functions generated by [hikage-gradle-plugin](../plugin/hikage-gradle-plugin.md) or [hikage-compiler](../library/hikage-compiler.md), the above rule is no longer necessary.
