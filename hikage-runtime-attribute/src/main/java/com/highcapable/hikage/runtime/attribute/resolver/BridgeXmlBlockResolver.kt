...
import com.highcapable.hikage.runtime.attribute.builder.PreviewXmlBuilder
...
import com.highcapable.hikage.runtime.attribute.extension.findLayoutPreviewContext
 ...
 * @param context the context to resolve the layoutlib bridge parser from.
 */
internal class BridgeXmlBlockResolver(private val context: Context) : XmlResourceParserResolver {

    private companion object {

        /** The Android Studio layout preview context class simple name. */
        const val BRIDGE_CONTEXT_CLASS_NAME = "BridgeContext"

        /** The layoutlib bridge parser class simple name. */
        const val BRIDGE_XML_BLOCK_PARSER_CLASS_NAME = "BridgeXmlBlockParser"

        /** The `ResourceNamespace.fromPackageName` method name. */
        const val FROM_PACKAGE_NAME_METHOD_NAME = "fromPackageName"

        /** The `ResourceNamespace.RES_AUTO` field name. */
        const val RES_AUTO_FIELD_NAME = "RES_AUTO"

        /** The `BridgeXmlBlockParser.ensurePopped` method name. */
        const val ENSURE_POPPED_METHOD_NAME = "ensurePopped"
    }
