...
object DeclaredSymbol {
    ...
    const val ANDROID_CONTENT_PACKAGE_NAME = "android.content"
    const val ANDROID_UTIL_PACKAGE_NAME = "android.util"

    const val ANDROID_CONTEXT_CLASS_NAME = "Context"
    const val ANDROID_CONTEXT_CLASS = "$ANDROID_CONTENT_PACKAGE_NAME.$ANDROID_CONTEXT_CLASS_NAME"
    const val ANDROID_ATTRIBUTE_SET_CLASS_NAME = "AttributeSet"
    const val ANDROID_ATTRIBUTE_SET_CLASS = "$ANDROID_UTIL_PACKAGE_NAME.$ANDROID_ATTRIBUTE_SET_CLASS_NAME"
    ...
    const val HIKAGE_LAYOUT_PACKAGE_NAME = "$HIKAGE_CORE_PACKAGE_NAME.layout"
    const val HIKAGE_ATTRIBUTE_PACKAGE_NAME = "$HIKAGE_CORE_PACKAGE_NAME.attribute"
    ...
    const val HIKAGE_LAYOUT_PARAMS_CLASS_NAME = "LayoutParams"
    const val HIKAGE_LAYOUT_PARAMS_CLASS = "$HIKAGE_LAYOUT_PACKAGE_NAME.$HIKAGE_LAYOUT_PARAMS_CLASS_NAME"
    ...
    const val HIKAGE_ATTRIBUTE_LAMBDA_CLASS_NAME = "HikageAttribute"
    const val HIKAGE_ATTRIBUTE_LAMBDA_CLASS = "$HIKAGE_ATTRIBUTE_PACKAGE_NAME.$HIKAGE_ATTRIBUTE_LAMBDA_CLASS_NAME"
}