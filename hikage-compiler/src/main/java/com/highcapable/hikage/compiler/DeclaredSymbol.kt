...
object DeclaredSymbol {
    ...
    const val HIKAGE_ATTRS_PACKAGE_NAME = "$HIKAGE_CORE_PACKAGE_NAME.attrs"
    ...
    const val HIKAGE_ATTRIBUTE_LAMBDA_CLASS = "$HIKAGE_ATTRS_PACKAGE_NAME.$HIKAGE_ATTRIBUTE_LAMBDA_CLASS_NAME"
}